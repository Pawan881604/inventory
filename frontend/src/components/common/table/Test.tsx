...
import { columns2 as columns, users, statusOptions } from "./data";
...
const Test: React.FC<list_props> = ({set_open})=> {
            ...
            <div className="flex flex-col gap-4">
                <div className="flex justify-between gap-3 items-end">
                    ...
                    <div className="flex gap-3">
                        ...
                        <Button color="primary" onClick={()=>set_open(true)} endContent={<PlusIcon />}>
                            Add New
                        </Button>
                    </div>
                </div>
